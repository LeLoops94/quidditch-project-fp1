...
public class exe8 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (meses_proyectados <= meses_a_proyectar) {
            ...
            cantidad_hormigas = cantidad_hormigas >= maximo_hormigas ? cantidad_hormigas * 1.4
                    : cantidad_hormigas * 1.31;
            cantidad_hormigas = cantidad_hormigas - oso_consumo <= 0 ? 0 : cantidad_hormigas - oso_consumo;
